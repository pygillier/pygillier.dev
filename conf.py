...
BLOG_EMAIL = "hello@pygillier.me"
BLOG_DESCRIPTION = "Code and experiments"  # (translatable)
...
GLOBAL_CONTEXT = {
        'INITIALS': 'PYG',
        'TWITTER_URL': 'https://twitter.com/pygillier',
        'GITHUB_URL': 'https://github.com/pygillier',
        'LINKEDIN_URL': None,
